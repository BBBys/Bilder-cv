...
from dbparam import *
from bilderanalysieren import bilderAnalysieren
...
def main():
    ...
    try:
        ...
        ok = bilderAnalysieren(mydb, TITEL)
        if ok:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(prog=TITEL, description="Bilder analysieren ")
    parser.add_argument(
        "-v",
        "--verbose",
        dest="pVerbose",
